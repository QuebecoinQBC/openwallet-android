...
/*import com.openwallet.core.coins.AsiacoinMain;
import com.openwallet.core.coins.AuroracoinMain;
import com.openwallet.core.coins.BatacoinMain;
import com.openwallet.core.coins.BitcoinMain;
import com.openwallet.core.coins.BitcoinTest;
import com.openwallet.core.coins.BlackcoinMain;
import com.openwallet.core.coins.BurstMain;
import com.openwallet.core.coins.CanadaeCoinMain;
import com.openwallet.core.coins.CannacoinMain;
import com.openwallet.core.coins.ClamsMain;
import com.openwallet.core.coins.ClubcoinMain;*/
...
import com.openwallet.core.coins.DigitalcoinMain;
import com.openwallet.core.coins.DogecoinMain;
import com.openwallet.core.coins.DogecoinTest;
import com.openwallet.core.coins.EguldenMain;
import com.openwallet.core.coins.FeathercoinMain;
import com.openwallet.core.coins.GcrMain;
import com.openwallet.core.coins.GuldenMain;
import com.openwallet.core.coins.JumbucksMain;
import com.openwallet.core.coins.LitecoinMain;
import com.openwallet.core.coins.LitecoinTest;
import com.openwallet.core.coins.MonacoinMain;
import com.openwallet.core.coins.NamecoinMain;
import com.openwallet.core.coins.NeoscoinMain;
...
import com.openwallet.core.coins.ShadowCashMain;
import com.openwallet.core.coins.UroMain;
import com.openwallet.core.coins.VergeMain;
...
import com.openwallet.core.coins.QuebecoinMain;
...
public class Constants {
    ...
    static {
        ...
        COINS_ICONS.put(CoinID.QUEBECOIN_MAIN.getCoinType(), R.drawable.quebecoin);

        COINS_BLOCK_EXPLORERS = new HashMap<CoinType, String>();
        COINS_BLOCK_EXPLORERS.put(CoinID.QUEBECOIN_MAIN.getCoinType(), "https://www.blockseek.io/qbc/tx/%s");
    }

    public static final CoinType DEFAULT_COIN = QuebecoinMain.get();
    public static final List<CoinType> DEFAULT_COINS = ImmutableList.of((CoinType) QuebecoinMain.get());
